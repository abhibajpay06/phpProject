...
if(isset($_POST['submit'])){
	...
	$registration_no = sanitizeInput($conn, $_POST['registration_no']);
	...
	$total_days = (strtotime($leave_to)-strtotime($leave_from))/(60*60*24)+1; //total leave days
	$status = 'Pending';
	
	leaveApplicationForm ($conn, $course, $name, $email, $registration_no, $leave_purpose, $leave_from, $leave_to, $total_days, $status);
}
?>
<!DOCTYPE html>
								  ...
								  <div class="card mb-4">
									...
									<div class="card-body">
									  ...
									  <!--Dinamically from db table-->
										  ...
										  <input type="hidden" class="form-control" name="course" value="<?= $course_name; ?>"/>
										  <input type="hidden" class="form-control" id="basic-default-fullname" name="name" value="<?= $full_name;?>"/>
										  <input type="hidden" class="form-control" id="basic-default-fullname" name="email" value="<?= $email;?>"/>
										  <input type="hidden" class="form-control" id="basic-default-fullname" name="registration_no" value="<?= $registration_no;?>"/>
