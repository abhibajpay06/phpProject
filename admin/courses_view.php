                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
					...
					<?php foreach($row as $fetch){?>
                      <tr>
                        <td><?= $fetch['course_name'];?></td>
                        <td><?= $fetch['course_duration'];?></td>
                        <td><?= $fetch['course_fee'];?></td>
                        <td><a href = "courses_update.php?id=<?= $fetch['id']?>">Update</a></td>
                        <td><a href = "courses_delete.php?id=<?= $fetch['id']?>">Delete</a></td>
                      </tr>
					 <?php } ?>
                    </tbody>
                  </table>
