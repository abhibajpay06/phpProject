                  ...
                  <table class="table">
					...
					<?php foreach($row as $fetch){?>
                      <tr>
                        ...
                        <td><?=$fetch['email'];?></td>
                        <td><?=$fetch['course'];?></td>
                        <td><?=$fetch['leave_purpose'];?></td>
                        <td><?=$fetch['leave_from'];?></td>
                        <td><?=$fetch['leave_to'];?></td>
                        <td><?=$fetch['total_days'];?></td>
                        <td><?=$fetch['applied_on'];?></td>
                        <td><?=$fetch['status'];?></td>
                        <td><a class="btn btn-success" href="leave_approve.php?id=<?= $fetch['id'];?>">Approve</a>
							<a class="btn btn-danger" href="leave_reject.php?id=<?= $fetch['id'];?>">Reject</a>
						</td>
                      </tr>
					 <?php } ?>
                    </tbody>
